...
from pipeline.layout_token_guidance_sdxlcontrolnet_pipeline import StableDiffusionXLControlNetPipelineModify
...
output_dir = './ouput/sdxlcontrolnet_layout_token/'
