...
from pipeline.layout_guidance_sdxlcontrolnet_pipeline import StableDiffusionXLControlNetPipelineModify
...
prompt = "A cap and a red bird, next to a lake, sunset"
...
max_guidance_iter_per_step_list = [5,10,20,30]

output_dir = './ouput/sdxlcontrolnet_/'
...
# max_guidance_iter_per_step = 10更好？